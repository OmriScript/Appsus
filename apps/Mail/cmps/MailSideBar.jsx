    ...
    render() {
        return (
            <section className="mail-side-bar flex column ">
                ...
                <ul>
                    <li className="mail-inbox-btn" onClick={() => this.props.getMails('inMails') }><a> Inbox </a></li>
                    <li className="mail-starred-btn"><a >Starred </a></li>
                    <li className="mail-sent-btn" onClick={() => this.props.getMails('outMails')}><a >Sent Mail </a></li>
